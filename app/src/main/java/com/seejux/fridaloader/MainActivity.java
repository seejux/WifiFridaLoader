package com.seejux.fridaloader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  executeCommand("su 0 /system/bin/cp /data/local/tmp/blah.txt /data/local/tmp/blah2.txt", false);
        ...
        if(rootedUsingMagisk())
        {
            ...
            command_launch_frida = "su -c /data/local/tmp/frida-server-latest -l 0.0.0.0 &";
            ...
            command_launch_frida = "su 0 /data/local/tmp/frida-server-latest -l 0.0.0.0 &";
